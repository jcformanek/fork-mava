...
from mava.offline.mabcq import MABCQTrainer, MABCQExecutor
...
class MABCQ:
    ...
    def __init__(  # noqa
        ...
        trainer_fn = MABCQTrainer,
        executor_fn = MABCQExecutor,
    ...
    def evaluator(
        ...
        get_keys = []
        for net_type_key in ["observations", "values", "behaviours"]:
            for net_key in networks[net_type_key].keys():
        ...
        executor = self._executor_fn(
            ...
            counts=counts,
            bcq_threshold=self._bcq_threshold,
