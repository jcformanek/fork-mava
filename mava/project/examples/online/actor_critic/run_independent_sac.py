...
from mava.project.systems.online.actor_critic.independent_sac import IndependentSAC
...
def make_cartpole(num_agents=1, evaluation=False):
    return IndependentCartPole(num_agents)
