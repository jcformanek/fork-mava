...
from typing import Callable, Dict, Mapping, Optional, Type, Union, Any
...
from mava.systems.tf.dist_madqn.training import DistMADQNTrainer
...
class DistMADQN(MADQN):
    ...
    def __init__(
        ...
        executor_fn: Type[DistMADQNExecutor] = DistMADQNExecutor,
        num_atoms: int = 51,
        num_executors: int = 1,
